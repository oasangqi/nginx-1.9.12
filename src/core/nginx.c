...
/* master进程通过该接口读取平滑升级时旧的Nginx服务监听的句柄 */
static ngx_int_t
...
ngx_get_cpu_affinity(ngx_uint_t n)
{
	...
	/* 超过给定绑定CPU个数的worker进程绑定到给定的最后一个CPU */
